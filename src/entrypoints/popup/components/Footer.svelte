<script lang="ts">
  ...
  import { RotateCcw, Book, GitBranch } from "@lucide/svelte";
...
<footer class="flex min-w-full justify-around p-4 mt-4">
  ...
  <div class="flex gap-3">
    <Button title="Wiki" id="wiki" onclick={handleWikiClick}><Book size={22} /></Button>
    <Button title="Discord" id="discord" onclick={handleDiscordClick}
      ...
      ></Button>
    <Button title="Reset" id="reset" onclick={handleResetClick}><RotateCcw size={22} /></Button>
  </div>
</footer>
